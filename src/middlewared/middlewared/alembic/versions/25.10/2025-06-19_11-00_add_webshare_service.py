...
def upgrade():
    op.create_table(
        ...
        sa.Column('srv_search_max_file_size', sa.BigInteger(), nullable=False),
        ...
        sa.Column('srv_search_archive_max_size', sa.BigInteger(), nullable=False),
        sa.Column('srv_search_index_max_size', sa.BigInteger(), nullable=False),
